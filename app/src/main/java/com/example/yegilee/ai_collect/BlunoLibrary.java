    ...
    public void onCreateProcess()
    {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			...
			if(permissionCheck == PackageManager.PERMISSION_DENIED){
				// 권한 없음
				ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1000);
			} else{ /* ACCESS_FINE_LOCATION 에 대한 권한이 이미 있음*/  }


		} else{ /* OS가 Marshmallow 이전일 경우 권한체크를 x */ }
		...
		.setTitle("Bluetooth Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
